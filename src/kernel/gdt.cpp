...
descriptor_t m_gdt[GDT_SIZE];
GDT_POINTER m_gdtPtr;
TSS_T m_tss;

// Gdt::~Gdt(){};

void setMemory(descriptor_t *desc, uint32 base, uint32 limit)
{
...
void tssInit()
{
    ...
    m_tss.ss0 = KERNEL_DATA_SELECTOR;
    m_tss.iobase = sizeof(m_tss);
    descriptor_t *desc = m_gdt + KERNEL_TSS_INDEX;
